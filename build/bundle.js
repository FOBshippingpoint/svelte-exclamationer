    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file, 60, 2, 1495);
    			...
    			add_location(script0, file, 65, 2, 1619);
    			...
    			add_location(script1, file, 67, 2, 1711);
    			...
    			add_location(script2, file, 68, 2, 1787);
    			...
    			add_location(script3, file, 71, 2, 1913);
    			...
    			add_location(select, file, 91, 8, 2670);
    			attr_dev(label0, "class", "select padding-top-xs");
    			add_location(label0, file, 90, 6, 2624);
    			attr_dev(label1, "for", "markType");
    			attr_dev(label1, "class", "lead");
    			add_location(label1, file, 88, 4, 2570);
