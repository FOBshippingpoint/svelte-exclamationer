...
<div class="flex align-items-center">
  <span class="lead">輸入</span>
  <button on:click={handleClear} id="clear" class="margin-left-m button-xs"
    ><svg
...
<textarea bind:this={textareaEl} bind:value id="input" cols="50" rows="5" />
